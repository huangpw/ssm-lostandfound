		...
		<div class="layui-col-md9">
			<div class="layui-card">
				...
				<div class="layui-card-body">
					...
					<form class="layui-form"  action="${pageContext.request.contextPath}/board/edit" method="post">
						...
						<div class="layui-row layui-col-space10 layui-form-item">
							...
							<div class="layui-col-lg10">
								...
								<div class="layui-input-block">
									<input type="text" name="title" id="title"  placeholder="请输入公告标题" value="${record.title}" autocomplete="off" class="layui-input">
								</div>
							</div>
						</div>
						<div class="layui-row layui-col-space10 layui-form-item">
							...
							<div class="layui-col-lg10">
								...
								<div class="layui-input-block">
									<textarea id="content" name="content" style="display: none;" placeholder="请输入详细内容" class="layui-textarea">${record.content}</textarea>
								</div>
							</div>
						</div>
						<%--按钮组--%>
