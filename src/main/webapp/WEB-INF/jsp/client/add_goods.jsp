...
<div class="inside_wrap">
    <div class="inside_con">
        <div class="adr">
            <a href="index.html">首页</a>&nbsp;>&nbsp;失物管理&nbsp;>&nbsp;发布失物
        </div>
        <div class="inside_box">
            <%--LEft--%>
            <jsp:include page="/WEB-INF/jsp/common/left.jsp"></jsp:include>
            <div class="ic_wrap fr">
                <form class="layui-form" action="<%=path%>/goods/add" method="post">
                    <%--物品名称--%>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-upload-drag" id="headImg" style="padding: 10px 40px;margin-left: 30px;">
                            <img class="layui-upload-img headImage" src="<%=path%>/static/images/upload.png" id="demo1"
                                 style="width:100px;height:100px;">
                            <p id="demoText" style="text-indent: 0; text-align: center;"></p>
                            <p style="text-indent: 0; text-align: center;">点击上传图片</p>
                        </div>
                        <input type="hidden" name="gods_img" id="gods_img"/>
                    </div>
                    <%--拾到地点--%>
                    <div class="layui-form-item layui-form-text">
                        <label class="layui-form-label">拾到地点</label>
                        <div class="layui-input-block">
                            <textarea name="spot" placeholder="请输入拾到地点" class="layui-textarea"></textarea>
                        </div>
                    </div>
                    <%--备注--%>
                    <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea id="detail" name="detail" style="display: none;" placeholder="请输入详细内容" class="layui-textarea"></textarea>
                            <%--<textarea name="detail" id="detail" placeholder="请输入详细内容" class="layui-textarea">${record.detail}</textarea>--%>
